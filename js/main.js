(function() {
    ...
    window.CanvasSlideshow = function( options ) {
      ...
      /// ---------------------------      
      options                     = options || {};
      options.stageWidth          = options.hasOwnProperty('stageWidth') ? options.stageWidth : 1180;
      ...
      options.textColor           = options.hasOwnProperty('textColor') ? options.textColor : '#333';
      ...
      this.initPixi = function() {
        ...
        if ( options.fullScreen === true ) {
          ...
          renderer.view.style.height  = '80%';
          renderer.view.style.top       = '50%';
          renderer.view.style.left      = '50%';
          renderer.view.style.webkitTransform = 'translate( 20%, -50% )';
          renderer.view.style.transform = 'translate( 20%, -50% )';          
        }
      ...
      for ( var i = 0; i < nav.length; i++ ) {
        ...
        navItem.onmouseover = function( event ) {
          ...
          if ( this.getAttribute('data-nav') === 'projthree' ) {

              that.moveSlider( 2 );
            
			  

          } else if ( this.getAttribute('data-nav') === 'projtwo' ) {

              that.moveSlider( 1 );
			  
		  } else if ( this.getAttribute('data-nav') === 'projone' ) {

              that.moveSlider( 0 );
          }  else if ( this.getAttribute('data-nav') === 'projfour' ) {

              that.moveSlider( 3 );
          }
			else if ( this.getAttribute('data-nav') === 'projfive' ) {
